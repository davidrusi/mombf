...
#Omegaini= Th
#fit <- modelSelectionGGM(y, sampler='birthdeath', Omegaini=Omegaini, niter=100, burnin=0, updates_per_iter=ncol(y), updates_per_column = 10, scale=FALSE, almost_parallel='none', tempering=1, truncratio=100, save_proposal=TRUE, prob_parallel=0.5)
